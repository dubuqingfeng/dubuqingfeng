...
export default function PublishTX() {
  ...
  return (
    <Layout title="Publish Ethereum Serialized Transaction" description="Publish Ethereum serialized transaction">
      <div className={DocPageStyles.docPage}>
      <PageSidebar 
        sidebar={ToolsSidebarData} path="/tools/ethereum/publishtx">
      </PageSidebar>
      ...
      <div className={clsx('container', 'padding-top--md', 'padding-bottom--lg')}>
              ...
              <div>
                <Center>
                    <h1 style={{ marginTop: "16px", }}>Publish Serialized Transaction</h1>
                </Center>
              </div>
        </div>
      <div>
