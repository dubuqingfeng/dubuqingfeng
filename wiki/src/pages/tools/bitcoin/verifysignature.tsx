...
export default function VerifySignature() {
  ...
  return (
    <Layout title="Verify Bitcoin Signature" description="Decode Bitcoin serialized transaction">
      <div className={DocPageStyles.docPage}>
      <PageSidebar 
        sidebar={ToolsSidebarData} path="/tools/bitcoin/verifysignature">
      </PageSidebar>
      ...
      <div className={clsx('container', 'padding-top--md', 'padding-bottom--lg')}>
              ...
              <div>
                <Center>
                    <h1 style={{ marginTop: "16px", }}>Verify Bitcoin Signature</h1>
                </Center>
              </div>
        </div>
      <div>
